...
public class RMStatusCPPScenario extends TafTestBase {
    ...
    public void testChangeRoleStatusOnRoleManagementPage() throws Exception {
        final TestScenario scenario = scenario("Role Management Status scenario")
                ...
                .addFlow(actionButtonsFlow.verifyEnableSingleRoleNotCppOrCom(CSV_TEST_ROLES))
                .addFlow(actionButtonsFlow.verifyDisableSingleRoleNotCppOrCom(CSV_TEST_ROLES))
                .addFlow(actionButtonsFlow.verifyNonassignableSingleRoleNotCppOrCom(CSV_TEST_ROLES))
                .addFlow(actionButtonsFlow.verifyEnableMultipleRole())
                .addFlow(actionButtonsFlow.verifyDisableMultipleRole()).addFlow(actionButtonsFlow.verifyNonassignableMultipleRole())
                .addFlow(loginLogoutFlow.logout()).addFlow(loginLogoutFlow.cleanUpFlow()).withExceptionHandler(new UiExceptionHandler(context))
                .build();
