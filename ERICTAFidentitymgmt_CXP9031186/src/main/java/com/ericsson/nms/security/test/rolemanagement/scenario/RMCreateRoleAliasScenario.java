...
public class RMCreateRoleAliasScenario extends TafTestBase {
    private static final String ROLE_TO_CREATE_CSV = "data/rolemanagement/testComRoles.csv";
    private static final String ROLE_TO_CLEAN_UP_CSV = "data/rolemanagement/testRoles.csv";
    ...
    @TestSuite
    public void testCreateCOMRoleAlias() throws Exception {
        context.addDataSource(TEST_DS, fromCsv(TEST_DS_CSV));
        final TestScenario scenario = dataDrivenScenario("Role Management - Create COM Role Alias")
                ...
                .addFlow(createRoleFlow.verifyComRoleAliasCreate(CSV_TEST_ROLES))
